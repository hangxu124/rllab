...
<box2d>
  <world timestep="0.01" velitr="20" positr="20">
    ...
    <body name="arm3" type="dynamic" position="0,4" >
      <fixture
              density="1.0"
              group="-1"
              shape="polygon"
    ...
    <joint type="revolute" name="arm_joint_3" bodyA="arm2" bodyB="arm3" anchor="0,4"/>
    <!-- <control type="torque" joint="link_joint_1" ctrllimit="-3,3"/> -->
    <control type="torque" joint="arm_joint_2" ctrllimit="-50,50" />
    <control type="torque" joint="arm_joint_3" ctrllimit="-50,50" />
    ...
    <state type="apos" body="arm3" transform="sin"/>
    <state type="apos" body="arm3" transform="cos"/>
    <state type="avel" body="arm3"/>
