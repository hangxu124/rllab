...
<box2d>
  <world timestep="0.01" velitr="20" positr="20">
    ...
    <body name="ob1" type="static" color="1,2,3" position="1.2,2.99" >
      <fixture group="-1" shape="circle" radius="0.05"/>
    </body>

    <body name="ob2" type="static" color="1,2,3" position="-1.2,0.99" >
      <fixture group="-1" shape="circle" radius="0.05"/>
    </body>

    <joint type="revolute" name="arm_joint_1" bodyA="track" bodyB="arm1" anchor="0,2"/>
    <joint type="revolute" name="arm_joint_2" bodyA="arm1" bodyB="arm2" anchor="0,3" limit="0 150"/>
